...
def load_message(name):
    try:
        ...
        return f"Режим {name} активирован."
...
def load_prompt(name):
    try:
        ...
        # Стандартные промпты если файлы не найдены
        default_prompts = {
            "gpt": "Ты полезный ассистент. Отвечай кратко и по делу.",
            "profile": "Создай привлекательный профиль для знакомств на основе данных пользователя.",
            "opener": "Напиши первое сообщение для знакомства.",
            "message_nest": "Напиши следующее сообщение в переписке от имени парня. Будь остроумным и интересным.",
            "message_date": "Пригласи девушку на свидание. Будь уверенным, но не навязчивым.",
            "date_robbi": "Ты Марго Робби. Ты общаешься с поклонником. Будь дружелюбной, с юмором, но немного загадочной.",
            "date_zendaya": "Ты Зендея. Ты общаешься с поклонником. Будь милой и открытой.",
            "date_gosling": "Ты Райан Гослинг. Ты общаешься с поклонницей. Будь крутым, лаконичным, с чувством юмора.",
            "date_hardy": "Ты Том Харди. Ты общаешься с поклонницей. Будь брутальным, но дружелюбным."
        }
        return default_prompts.get(name, f"Ты ассистент. Отвечай на вопросы пользователя.")


class Dialog:
    def __init__(self):
        self.mode = None
        self.list = []  # История переписки
        self.user = {}
        self.count = 0
        self.current_star = None  # Текущая выбранная звезда